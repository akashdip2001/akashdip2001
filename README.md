...
| **LAN System Monitor** 👓 | Windows background agent exposing real-time CPU, RAM, Disk, Network and Process metrics via WebSocket-powered web dashboard. <br>**Tech:** Python, FastAPI, Uvicorn, psutil, WebSockets, PyInstaller | [View Repo](https://github.com/akashdip2001/local-directory-access-Py) | `Python`, `Network`, `Monitoring`, `Web`, `System Tools` |
